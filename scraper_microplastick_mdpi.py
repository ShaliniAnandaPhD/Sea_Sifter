...
def main():
    ...
    """
    base_url = 'https://www.mdpi.com/journal/microplastics'  # Replace with the base URL of the articles
    for i in range(1000):  # Loop over 1000 articles (adjust as needed)
